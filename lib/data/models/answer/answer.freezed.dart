...
abstract class $AnswerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, bool? isRight});
}
...
class _$_Answer implements _Answer {
  const _$_Answer({this.name, this.isRight});
  ...
  @override
  String toString() {
    return 'Answer(name: $name, isRight: $isRight)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, isRight);
...
abstract class _Answer implements Answer {
  const factory _Answer({final String? name, final bool? isRight}) = _$_Answer;
